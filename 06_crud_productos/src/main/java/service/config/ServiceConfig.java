...
@EnableTransactionManagement //para habilitar la transaccionalidad usando anotación @Transactional
...
public class ServiceConfig {
	...
	//factoría EntityManager: Objeto para acceder a capa de persistencia con JPA
	@Bean
	public LocalContainerEntityManagerFactoryBean factory() {
		LocalContainerEntityManagerFactoryBean factory=new LocalContainerEntityManagerFactoryBean();
		factory.setPersistenceUnitName("productosPU");
